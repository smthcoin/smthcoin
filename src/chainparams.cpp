...
{
    const char* pszTimestamp = "CNN NEWS Tue May 11, 2021, Dogecoin is still in the dog house after Elon Musk's 'SNL' appearance";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1621345676, 2086087079, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa4560a858719ee9f961823a111d2c411d3258ca24cb9aea4e244bb61bcadb789"));
        assert(genesis.hashMerkleRoot == uint256S("0x06bebe7afb7bd54f87fcca77df3483010d36fe63e92365a45574111dfe62727c"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.smthcoin.loshan.co.uk", true);
        //vSeeds.emplace_back("dnsseed.thrasher.io", true);
        //vSeeds.emplace_back("dnsseed.smthcointools.com", true);
        //vSeeds.emplace_back("dnsseed.smthcoinpool.org", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {     0, uint256S("0xa4560a858719ee9f961823a111d2c411d3258ca24cb9aea4e244bb61bcadb789")},
        ...
        chainTxData = ChainTxData{
            1621345676, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // vSeeds.emplace_back("testnet-seed.smthcointools.com", true);
        // vSeeds.emplace_back("seed-b.smthcoin.loshan.co.uk", true);
