...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s smthcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  smthcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded smthcoin transaction") + "\n" +
              "  smthcoin-tx [options] -create [commands]   " + _("Create hex-encoded smthcoin transaction") + "\n" +
              "\n";
