...
const char * const BITCOIN_CONF_FILENAME = "smthcoin.conf";
const char * const BITCOIN_PID_FILENAME = "smthcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Smthcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Smthcoin";
#else
    // Unix
    return pathRet / ".smthcoin";
#endif
#endif
}
