...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/smthcoin-project/smthcoin>";
    const std::string URL_WEBSITE = "<https://smthcoin.org>";
